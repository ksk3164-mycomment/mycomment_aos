...
import kotlinx.android.synthetic.main.list_item_talk_bookmark_grid.view.*
...
class TalkBookmarkGridAdapter(val activity: FragmentActivity?, var items: MutableList<TalkModel>) :
    RecyclerView.Adapter<TalkBookmarkGridAdapter.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(
            LayoutInflater.from(parent.context).inflate(
                R.layout.list_item_talk_bookmark_grid,
                parent,
                false
            )
        )
